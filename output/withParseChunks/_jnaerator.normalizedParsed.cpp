...
extern ""C"" {
/// Original signature : <code>int* _errno()</code>
	extern __cdecl int* _errno();
	/// Original signature : <code>errno_t _set_errno(int)</code>
	__cdecl errno_t _set_errno(int _Value);
	/// Original signature : <code>errno_t _get_errno(int*)</code>
...
/// Original signature : <code>void LLVMLinkInJIT()</code>
	...
	typedef LLVMOpaqueGenericValue* LLVMGenericValueRef;
	typedef LLVMOpaqueExecutionEngine* LLVMExecutionEngineRef;
